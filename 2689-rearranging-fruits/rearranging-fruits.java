class Solution {
    public long minCost(int[] b1, int[] b2) {
        // 1. Create two "counters" (Maps) to see how many of each fruit are in each basket. \U0001f34e\U0001f34c\U0001f347
        ...
        // 4. Create a set "all" that contains ALL the *different* types of fruit in either basket. \U0001f349\U0001f353\U0001f34d
        ...
        // 5. Find the *cheapest* fruit (the fruit with the lowest "cost"). We'll use this for sneaky cheap swaps later! \U0001f911
        int min = Integer.MAX_VALUE;

        // 6. Create two lists to store the fruits we need to *move* from one basket to the other. \U0001f69a
        ...
        for (int x : all) {
            ...
            // 10. If the total number of fruits "x" is *odd*, we can't balance the baskets. Return -1. \U0001f645‍♀️
            if (d % 2 != 0) return -1;
...
*/        
        ...
        // 13. Sort the lists of fruits we need to move.  "l1" in ascending order, "l2" in descending order. \U0001f5c2️
...
*/
        ...
        // 14. Calculate the *minimum cost* to balance the baskets by swapping the fruits. \U0001f4b0
        long res = 0;
...
*/
        ...
        // 16. Return the total minimum cost. \U0001f389
        return res;
    }
}